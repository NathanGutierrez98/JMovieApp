...
public class TutorialToken extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tutorial_token_principal);
    ...
    private void launchMain() {
        Intent i = new Intent(TutorialToken.this, LoginUsuario.class);
       startActivity(i);
        finish();
    }
